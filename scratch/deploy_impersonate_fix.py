...
FILES_TO_DEPLOY = [
    ...
    ("frontend/src/components/super-admin/SuperAdminDashboardView.jsx", "frontend/src/components/super-admin/SuperAdminDashboardView.jsx"),
...
def main():
    archive_name = "patch_impersonate_fix.tar.gz"
