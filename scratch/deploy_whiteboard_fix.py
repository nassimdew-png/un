...
FILES_TO_DEPLOY = [
    ("frontend/src/components/teletherapy/ClinicalInteractiveCanvas.jsx", "frontend/src/components/teletherapy/ClinicalInteractiveCanvas.jsx"),
...
def main():
    archive_name = "whiteboard_audio_fix.tar.gz"
