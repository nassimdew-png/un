...
ARCHIVE_NAME = "patch_help_center_studio_upgrade.tar.gz"
...
def main():
    print("1. Creating tar.gz archive for Help Center & SuperAdmin Studio CMS...")
    ...
    print("\n3. Extracting, Clearing Laravel Cache, Building Frontend, and Restarting PM2 on VPS...")
    remote_script = f"""
set -e
cd {REMOTE_BASE}
...
"""
    ...
    if res.returncode == 0:
        print("\n=== HELP CENTER & SUPERADMIN CMS STUDIO DEPLOYED SUCCESSFULLY! ===")
    else:
