...
ARCHIVE_NAME = "patch_ai_support_widget.tar.gz"

FILES_TO_PACK = [
    "frontend/src/App.jsx",
    "frontend/src/api.js",
    "frontend/src/components/common/AiSupportChatWidget.jsx",
    "frontend/src/components/settings/AiReceptionistSettingsView.jsx",
    "backend/app/Models/SupportConversation.php",
    "backend/app/Http/Controllers/Api/AiSupportAssistantController.php",
    "backend/routes/api.php",
]

def main():
    print("1. Creating tar.gz archive for AI Support Chat Widget...")
...
"""
    ...
    if res.returncode == 0:
        print("\n=== AI SUPPORT CHAT WIDGET DEPLOYED SUCCESSFULLY! ===")
    else:
        print("\nDeployment failed!")
        sys.exit(1)
