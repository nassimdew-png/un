...
ARCHIVE_NAME = "patch_secretary_role_permissions.tar.gz"
...
def main():
    print("1. Creating tar.gz archive for Secretary Role & Permissions...")
...
"""
    ...
    if res.returncode == 0:
        print("\n=== SECRETARY ROLE & RBAC DEPLOYED SUCCESSFULLY! ===")
    else:
        print("\nDeployment failed!")
        sys.exit(1)
