...
ARCHIVE_NAME = "patch_session_fixes.tar.gz"

FILES_TO_PACK = [
    "backend/routes/api.php",
    "backend/app/Http/Controllers/Api/TherapySessionController.php",
    "frontend/src/api.js",
    "frontend/src/components/SessionModal.jsx",
...
def main():
    ...
    print("\n3. Extracting, Checking PHP syntax, Building Frontend, and Restarting PM2...")
    remote_script = f"""
set -e
cd {REMOTE_BASE}
...
php -l backend/app/Http/Controllers/Api/TherapySessionController.php
