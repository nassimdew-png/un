...
ARCHIVE_NAME = "patch_pecs_matching_and_portal.tar.gz"

FILES_TO_PACK = [
    "backend/app/Http/Controllers/Api/ParentPortalController.php",
    "backend/app/Http/Controllers/Api/PatientAudioController.php",
    "backend/routes/api.php",
    "frontend/src/api.js",
    "frontend/src/components/teletherapy/PecsAndMatchingActivityModal.jsx",
    ...
    "frontend/src/components/teletherapy/ClinicalProtocolsModal.jsx",
    "frontend/src/components/ActiveConsultationWorkspace.jsx",
    "frontend/src/components/clinical/SpecialtyWorkspaces.jsx",
    "frontend/src/components/portal/ParentMediaUploadBox.jsx",
    "frontend/src/components/portal/ParentPortalView.jsx",
    "frontend/src/components/portal/ParentPreIntakePortalView.jsx",
    "frontend/src/components/ParentMobilePortal.jsx",
]
...
def main():
    ...
    print("\n3. Extracting, Optimizing Backend, Building Frontend and Restarting PM2 on VPS...")
    remote_script = f"""
set -e
cd {REMOTE_BASE}
