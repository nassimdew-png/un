...
ARCHIVE_NAME = "patch_patient_tablet_fixes.tar.gz"

FILES_TO_PACK = [
    "frontend/src/components/common/SearchablePatientSelect.jsx",
    "frontend/src/components/therapy/InteractiveTestPassationModal.jsx",
    "frontend/src/components/therapy/SendTestAssignmentModal.jsx",
...
php -l backend/app/Http/Controllers/Api/ClinicalTestAssignmentController.php
php -l backend/app/Http/Controllers/Api/ClinicalAssessmentCatalogController.php
php -l backend/app/Http/Controllers/Api/ClinicalAssessmentController.php
php -l backend/app/Http/Controllers/Api/PatientController.php
