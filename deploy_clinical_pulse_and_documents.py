...
ARCHIVE_NAME = "patch_pulse_and_documents.tar.gz"

FILES_TO_PACK = [
    "backend/app/Http/Controllers/Api/ClinicController.php",
    "frontend/src/components/dashboard/DailyClinicalPulse.jsx",
    "frontend/src/components/MedicalLettersBuilder.jsx",
    "frontend/src/components/Patients.jsx",
    "frontend/src/components/patients/PatientAiRecordsTab.jsx",
